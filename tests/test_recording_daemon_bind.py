...
from autocab.recording.paths import ENV_ALLOW_REMOTE, ENV_ADVERTISE_URL, ENV_BIND_HOST
...
def test_daemon_summary_rows_loopback(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("autocab.recording.bind.socket.gethostname", lambda: "noderome106")
