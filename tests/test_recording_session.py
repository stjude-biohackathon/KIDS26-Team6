...
import autocab.recording.session as session_module
from autocab.recording.session import (
    STATUS_ACTIVE,
    STATUS_PAUSED,
    STATUS_STOPPED,
    Session,
...
from autocab.recording.state import RecorderState, read_sentinel, sentinel_enables
...
def test_start_creates_folder_manifest_and_timeline(store, autocab_home):
